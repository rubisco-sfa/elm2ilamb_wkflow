...
if [[ $ilamb_fields == 1 ]]; then 
   ...
   fldlist_lmon="ALT AR BTRAN CH4PROD DENIT EFLX_LH_TOT ELAI ER ESAI FAREA_BURNED \
    ...
    SOIL1N SOIL2N SOIL3N SOIL1C SOIL2C SOIL3C TOTVEGC TOTVEGN TOTECOSYSC TOTLITC TOTLITC_1m \
    TOTLITN_1m TOTSOMC TOTSOMC_1m TOTSOMN_1m CWDC PBOT \
    QINTR LITR1C_TO_SOIL1C LITR2C_TO_SOIL2C LITR3C_TO_SOIL3C LITFALL QSNWCPICE DEADCROOTC LIVECROOTC PCT_NAT_PFT PCT_LANDUNIT TOTPRODC SOILWATER_10CM"
   ...
   #fldlist_amon="O3 CLDICE PSL FLNSC TAUX CLDLIQ SOLIN PS hybm hyam FSNT FLNT TGCLDIWP FSUTOAC TAUY CLOUD hyai hybi FLUTC TMQ CLDTOT U10 FSUTOA FSDSC FSNSC FSNTOA T QREFHT TGCLDCWP"
   fldlist_amon="area LANDFRAC"
   #fldlist_lmon="landfrac"

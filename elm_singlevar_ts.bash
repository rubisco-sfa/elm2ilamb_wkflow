...
print_usage () {
   ...
   echo -e "         \e[1m--ensemble             \e[0m: the ensemble number, for multi-instance it will 0001, 0002, 0003 etc."
...
parse_options () {
     ...
     while true; do
          case "$1" in
             ...
             --ensemble)
                     ensno=$2
     		echo -e "The ensemble no.: ${CR_GRN}$2${CR_NUL}"; shift 2 ;;
             --numcc)
                     nconcurrent=$2
     ...
     if [[ "x$ensno" == "x" ]]; then
        ...
        echo "processing ensmeble ...${ensno}"
        lnd="${lnd}_$ensno"
        atm="${atm}_$ensno"
     fi
}
